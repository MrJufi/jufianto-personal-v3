  ...
  return (
    <section className="about section" id="about">
      ...
      <div className="about__container container grid">
            <img src={AboutImg} alt="" className="about__img animate__animated animate__fadeInLeft" />

            <div className="about__data animate__animated animate__fadeIn">
                <Info/>
                ...
                <a href='https://drive.google.com/file/d/1T_rLsTj-1MBZOyeDR9qZTt6Uj-viZeSs/view?usp=drive_link' target='_blank'
